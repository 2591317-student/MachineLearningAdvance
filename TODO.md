...
- [x] **Quay video báo cáo 10–15 phút** → đặt tên `Nhom_10-Nhan_Kien_Tuan.mp4` (nặng thì up Google Drive, gửi link cho cô).
- [x] **Đẩy code lên GitHub/Colab** và kiểm tra link chạy được, hiển thị đủ cell + output.
- [x] **Nộp UTEXLMS** trước 17h CN 02/08/2026 (đủ: báo cáo + link code + slide + video/link video).
